...
// const message = `<html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml"><head>
...
// </td>
// </tr>
// </tbody></table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:0px 0px 0px 0px;" bgcolor="#f8f4ff" data-distribution="1">
// <tbody>
...
//     <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="334" alt="" data-proportionally-constrained="true" data-responsive="false" src="http://cdn.mcauto-images-production.sendgrid.net/08f09f157a0ae368/8294a83e-8a31-4e64-ad97-f70fb50fa5bd/2480x1338.png" height="180">
//   </td>
// </tr>
// </tbody>
...
// <tbody>
// <tr>
//   <td style="padding:18px 30px 18px 30px; line-height:40px; text-align:inherit; background-color:#f8f4ff;" height="100%" valign="top" bgcolor="#f8f4ff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 24px; color: #804ed9">שלום ${name}, וברוכים הבאים לאפליקציית Kesher!</span></div><div></div></div></td>
// </tr>
// </tbody>
...
// <tbody>
// <tr>
//   <td style="padding:18px 50px 18px 50px; line-height:22px; text-align:inherit; background-color:#F8F4FF;" height="100%" valign="top" bgcolor="#F8F4FF" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px">פרטי התחברות:</span></div>
// <div style="font-family: inherit; text-align: center"><span style="font-size: 18px">המייל אליו הגיעה הודעה זו</span></div>
// <div style="font-family: inherit; text-align: center"><span style="font-size: 18px">סיסמה: ${password}</span></div><div></div></div></td>
// </tr>
// </tbody>
// </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:30px 0px 0px 0px;" bgcolor="#F8F4FF" data-distribution="1">
// <tbody>
// <tr role="module-content">
...
// <tr>
//   <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
//     <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:75% !important; width:75%; height:auto !important;" width="450" alt="" data-proportionally-constrained="true" data-responsive="true" src="http://cdn.mcauto-images-production.sendgrid.net/08f09f157a0ae368/3a4d5005-84b4-44dc-bcce-8eea94968574/2000x2000.png">
//   </td>
// </tr>
// </tbody>
// </table></td>
